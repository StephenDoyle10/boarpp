...
-ability to edit or delete the post
-ability to post a comment under your own, or someone elses, post
-click on a username to be directed to another page that features all the posts created by that user
-click on the a particular post to be directed to another page that features only that post
